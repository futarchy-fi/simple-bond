...
/// @title PosterProfileRegistry
/// @notice Append-only registry of poster profiles. Each registration creates
///         a new immutable entry with a fresh entryId.
contract PosterProfileRegistry {
    struct Entry {
        address owner;
        bytes32 contentHash;
        string content;
